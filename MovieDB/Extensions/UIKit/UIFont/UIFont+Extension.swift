...
struct AppFontName {
    static let light = "DINNextLTW23-Light"
    static let regular = "DINNextLTW23-Regular"
    static let semiBold = "DINNextLTW23-Medium"
    static let bold = "DINNextLTW23-Bold"
    static let italic = "DINNextLTW23-Light"
}
